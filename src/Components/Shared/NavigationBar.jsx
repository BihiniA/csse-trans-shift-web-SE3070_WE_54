...
function NavigationBar(props) {
  ...
  const renderMenu = (
    ...
    >
      <MenuItem className={classes.hover} onClick={handleMenuClose}>
        Profile
      </MenuItem>
      <MenuItem className={classes.hover} onClick={handleMenuClose}>
        My account
      </MenuItem>
      <MenuItem className={classes.hover} onClick={() => SignOut()}>
        Sign Out
      </MenuItem>
    </Menu>
  );
      ...
      <AppBar position="static" style={{ color: "white" }}>
        <Toolbar>
          ...
          <Typography className={classes.title} variant="h6" noWrap>
            <img
              src={Logo}
              style={{ marginTop: "-19px", marginBottom: "-7px" }}
            />{" "}
            <h4
              style={{
                marginLeft: "60px",
